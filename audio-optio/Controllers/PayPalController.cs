...
using PayPal.Api;
using PayPalOrder = PayPal.Api.Order;
...
namespace audio_optio.Controllers
{
    public class PayPalController : Controller
    {
        ...
        {
            ContactOrderModel contactOrder = TempData["order_details"] as ContactOrderModel;

            PaymentModel model = new PaymentModel { contactOrder = contactOrder };
            model.Price = model.contactOrder == null ? 0.0f : ContactOrderModel.getPrice(model.contactOrder.order.Size);
